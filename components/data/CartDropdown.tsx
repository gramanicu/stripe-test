...
export default function CartDropdown() {
    return (
        <Popover className="relative flex flex-row items-center justify-center">
            {({ open }) => (
                <>
                    <Popover.Button
                        className={`
                ...
                group inline-flex items-center rounded-md text-base font-medium text-white hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}>
                  ...
                  ml-2 h-5 w-5 text-orange-300 transition duration-150 ease-in-out group-hover:text-opacity-80`}
                    ...
                    <Transition
                        ...
                        <Popover.Panel className="absolute top-6 right-0 z-10 mt-3 w-screen max-w-sm transform px-4 sm:px-0 lg:max-w-3xl">
